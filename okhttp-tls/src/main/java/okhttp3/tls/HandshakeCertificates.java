...
public final class HandshakeCertificates {
  ...
  public static final class Builder {
     ...
     * customizations.
     *
     * <p>Most TLS clients should that connect to hosts on the public Internet should call this
     * method. Otherwise it is necessary to manually prepare a comprehensive set of trusted roots.
     *
